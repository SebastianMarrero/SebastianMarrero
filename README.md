...
- ML & Analysis: pandas, NumPy, scikit-learn, matplotlib, seaborn, TextBlob, classification Modeling (LightGBM, XGBoost, Logistic Regression), Standard Scaling, Label Encoding, Precision-Recall Curves, Synthetic Minority Oversampling technique, Receiver Operating Charactersitic
